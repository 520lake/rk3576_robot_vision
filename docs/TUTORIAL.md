...
![实物接线图](./assets/hardware_wiring.jpg)

**图中设备说明：**

| 位置 | 设备 | 说明 |
|:---:|:---|:---|
| 左上 | 🔌 **USB 扩展坞** | 连接键盘、鼠标、U盘等外设 |
| 左中 | 📟 **RK3576 开发板** | 主控板，带散热片，运行视觉识别程序 |
| 左下 | 📷 **Logitech 摄像头** | USB 摄像头，用于图像采集 |
| 右下 | 🔌 **Arduino R4 Minima** | 舵机控制板，连接两个 SG90 舵机 |

**接线要点：**
- ✅ RK3576 通过 USB 连接 Arduino（串口通信）
- ✅ Arduino 5V/GND 给两个舵机供电
- ✅ 舵机信号线分别接 D9（X轴）、D10（Y轴）
- ✅ 摄像头 USB 直接插 RK3576
- ⚠️ 注意：舵机电源线（红色）接 5V，地线（棕色/黑色）接 GND
